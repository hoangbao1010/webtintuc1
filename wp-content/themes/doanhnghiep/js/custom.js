$(document).ready(function(){
    ...
    $('.qb_hot_new_header ul').owlCarousel({
        loop:true,
        margin:30,
        nav:true,
        dots:false,
    ...
    $('.qb_big_post_left ul').owlCarousel({
        loop:true,
        margin:30,
        nav:true,
        dots:false,
    ...
    $('.menu_zoom .icon_zoom').click(function(){
        $('.menu_zoom .zoom_width').slideToggle(300);
    });
