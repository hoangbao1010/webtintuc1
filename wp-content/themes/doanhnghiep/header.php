   ...
   <header>
      <div class="header">
         <div class="top_header">
            <div class="container">
               <div class="weather_date_time">
                  <?php echo do_shortcode('[hienthithu]'); ?>,
                  <?php echo do_shortcode('[hienthingay]'); ?>
                  <?php echo do_shortcode('[hienthithang]'); ?>,
                  <?php echo do_shortcode('[hienthinam]'); ?>
               </div>
            </div>
         </div>
