...
function ch_essentials_admin() {
	...
	/* Base Menu */
	add_menu_page('Zang Theme Option','Meta Framework','manage_options','template_admin_zang','zang_theme_create_page',get_template_directory_uri() . '/images/bitcoin.png',110);
}
